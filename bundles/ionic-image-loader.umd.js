(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@awesome-cordova-plugins/ionic-webview/ngx'), require('rxjs'), require('rxjs/operators'), require('@awesome-cordova-plugins/file/ngx/index'), require('@awesome-cordova-plugins/ionic-webview/ngx/index'), require('@angular/common'), require('@angular/common/http'), require('@angular/core'), require('@awesome-cordova-plugins/file/ngx'), require('@ionic/angular')) :
    typeof define === 'function' && define.amd ? define('ionic-image-loader', ['exports', '@awesome-cordova-plugins/ionic-webview/ngx', 'rxjs', 'rxjs/operators', '@awesome-cordova-plugins/file/ngx/index', '@awesome-cordova-plugins/ionic-webview/ngx/index', '@angular/common', '@angular/common/http', '@angular/core', '@awesome-cordova-plugins/file/ngx', '@ionic/angular'], factory) :
